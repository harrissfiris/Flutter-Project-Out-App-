...
class CustomSearchBarNew extends StatefulWidget {
  ...
  @override
  State<CustomSearchBarNew> createState() => _CustomSearchBarState();
}

class _CustomSearchBarState extends State<CustomSearchBarNew> {
    ...
    return Column(
      ...
      children: [
        ...
        if (_searchResults.isNotEmpty)
          SizedBox(
            height: 500, // Ορισμός ύψους για τη λίστα
